...
public class Jdbc3 {
    public static void main(String[] args) {
        ...
        String sql = "insert into tb_member(mem_userid, mem_userpw, mem_name, mem_hp, mem_email, mem_hobby, " +
                "mem_ssn1, mem_ssn2, mem_zipcode, mem_address1, mem_address2, mem_address3)"+
                "values ('"+mem_userid+"','"+mem_userpw+"','"+mem_name+"','"+mem_hp+"','"+mem_email+"','"+mem_hobby+"','"+mem_ssn1+"','"+mem_ssn2+"','"+mem_zipcode+"','"+mem_address1+"','"+mem_address2+"','"+mem_address3+"')";
