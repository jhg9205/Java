...
public class HashMap1 {
    public static void main(String[] args) {
        ...
        System.out.println(hashMap.keySet());       // 키 값만 확인
        System.out.println(hashMap.entrySet());     // key, value 모두 확인

        for(String k : hashMap.keySet()){
            System.out.println(k + " " + ", value " + hashMap.get(k));
        }
        System.out.println();
        ...
        while(keys.hasNext()){
            ...
            System.out.println("[key]" + key + "[valus]" + hashMap.get(key));
        }
    }
}
