...
public class Oop6 {
    public static void main(String[] args) {
        ...
        fruits[0] = new Apple("사과", 1000, "빨강", "제주도", 7);
        fruits[1] = new Banana("바나나", 2000, "노랑", "필리핀",10);
        fruits[2] = new Orange("오렌지", 1200, "주황", "호주",0.5);

        Scanner sc = new Scanner(System.in);
        Fruit[] order = new Fruit[10];      // 구입할 과일 목록을 저장할 배열

        int sel;        // 선택한 메뉴 번호
        int cnt = 0;    // 과일 구입 개수

        while (true) {
            System.out.println("메뉴룰 선택하세요. (1. 사과구입 2.바나나구입 3.오렌지구입 4.구입목록 5.과일검색 6.종료)");
            sel = sc.nextInt();
                if(sel == 6)break;
                switch (sel) {
                    case 1 :
                    ...
                    case 4 :
                        ...
                        break;
                    case 5 :
                        System.out.println("검색할 과일을 입력하세요.(1. 사과 2. 바나나 3. 오렌지");
